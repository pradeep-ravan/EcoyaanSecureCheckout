        ...
        <>
            ...
            <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 md:py-16 pb-32 lg:pb-32 pt-24 animate-fade-in relative z-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
                    ...
                    <div className="lg:col-span-7 space-y-8">
                        ...
                        <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-white/60 dark:border-slate-800/50 p-6 sm:p-8 animate-slide-up delay-100">
                            ...
                            <div className="bg-gradient-to-br from-gray-50/80 to-white/50 dark:from-slate-800/80 dark:to-slate-800/30 rounded-2xl p-5 border border-gray-100/80 dark:border-slate-700/50 shadow-inner relative group transition-all duration-300 hover:shadow-md dark:hover:shadow-slate-900/50">
                                ...
                                <p className="font-extrabold text-gray-900 dark:text-slate-100 pr-24 text-lg tracking-tight mb-2">{address?.fullName || 'No Name Provided'}</p>
                                <div className="space-y-1">
                                    <p className="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-400 font-medium"><span className="w-1.5 h-1.5 rounded-full bg-gray-300 dark:bg-slate-600"></span>{address?.email}</p>
                                    <p className="flex items-center gap-2 text-sm text-gray-600 dark:text-slate-400 font-medium"><span className="w-1.5 h-1.5 rounded-full bg-gray-300 dark:bg-slate-600"></span>{address?.phone}</p>
                                </div>
                                <div className="mt-4 pt-4 border-t border-gray-200/50 dark:border-slate-700/50 break-words leading-relaxed text-sm text-gray-600 dark:text-slate-400 font-medium">
                        ...
                        <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-white/60 dark:border-slate-800/50 p-6 sm:p-8 animate-slide-up delay-200">
                            <div className="flex items-center justify-between mb-8">
                                ...
                                <div className="flex gap-2">
                                    <div className="w-12 h-8 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/40 dark:to-blue-800/40 border border-blue-200/50 dark:border-blue-700/50 rounded-lg flex items-center justify-center text-[10px] font-extrabold text-blue-800 dark:text-blue-300 shadow-sm">VISA</div>
                                    <div className="w-12 h-8 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/40 dark:to-orange-900/40 border border-red-200/50 dark:border-red-700/50 rounded-lg flex items-center justify-center text-[10px] font-extrabold text-red-700 dark:text-red-300 shadow-sm">MC</div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <label className="flex items-center p-5 border border-white dark:border-slate-800 rounded-2xl bg-white/50 dark:bg-slate-900/50 cursor-not-allowed opacity-60 transition-all hover:bg-white/80 dark:hover:bg-slate-800/80">
                                    ...
                                    <span className="ml-4 font-bold text-gray-900 dark:text-slate-100 text-lg flex items-center">
                                        UPI <span className="text-[10px] bg-gray-200/80 dark:bg-slate-700 text-gray-600 dark:text-slate-300 px-2.5 py-1 rounded-full ml-3 uppercase font-extrabold tracking-wider">Coming Soon</span>
                                    </span>
                                </label>
                                <label className="flex items-center p-5 border border-white dark:border-slate-800 rounded-2xl bg-white/50 dark:bg-slate-900/50 cursor-not-allowed opacity-60 transition-all hover:bg-white/80 dark:hover:bg-slate-800/80">
                                    <input type="radio" disabled className="w-5 h-5 text-gray-400 dark:text-slate-600" />
                                    <span className="ml-4 font-bold text-gray-900 dark:text-slate-100 text-lg flex items-center">
                                        Net Banking <span className="text-[10px] bg-gray-200/80 dark:bg-slate-700 text-gray-600 dark:text-slate-300 px-2.5 py-1 rounded-full ml-3 uppercase font-extrabold tracking-wider">Coming Soon</span>
                                    </span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-5 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] border border-white/60 dark:border-slate-800/50 p-6 sm:p-8 lg:sticky lg:top-24 animate-slide-up delay-300">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100 mb-6 flex items-center gap-2">Final Summary</h2>

                        <div className="space-y-4 mb-8 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
                            {cartItems.map((item) => (
                                <div key={item.product_id} className="flex gap-4 border-b border-gray-100/80 dark:border-slate-800 pb-4 group">
                                    <div className="w-16 h-16 shrink-0 relative rounded-2xl overflow-hidden bg-gray-50 dark:bg-slate-800 border border-white/60 dark:border-slate-700/50 shadow-sm group-hover:scale-[1.05] transition-transform duration-300">
                                        <Image src={item.image} alt={item.product_name} fill className="object-cover" />
                                    </div>
                                    <div className="flex-1 min-w-0 flex flex-col justify-center">
                                        <h4 className="text-sm font-bold text-gray-900 dark:text-slate-100 truncate leading-tight">{item.product_name}</h4>
                                        <p className="text-gray-500 dark:text-slate-400 text-xs font-medium mt-1">Qty: {item.quantity}</p>
                                    </div>
                                    <div className="text-sm font-bold text-gray-900 dark:text-slate-100 flex items-center">
                        ...
                        <div className="space-y-4 text-base mb-8">
                            ...
                            <div className="border-t border-gray-200/80 dark:border-slate-700/80 pt-4 mt-4 flex justify-between items-end">
                                <div>
